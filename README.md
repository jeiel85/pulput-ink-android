...
- **AI / STT**: OpenAI Whisper API (단말 내 whisper.cpp ggml 모델 다운로드 매니저 포함, 추론은 향후 추가)
- **AI / Text**: OpenAI Chat Completions (gpt-4o-mini)
...
> 키 하나로 음성 전사(Whisper)와 AI 가공(요약·아웃라인·성경 구절 추출)이 모두 동작합니다.
